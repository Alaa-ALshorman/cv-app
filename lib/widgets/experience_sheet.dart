...
class _ExperienceSheetState extends State<ExperienceSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color cardBg = widget.isDark ? const Color(0xFF00332B) : Colors.white;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: const BorderRadius.vertical(top: Radius.circular(50)), // انحناء الحبة
      ),
      child: Column(
        children: [
          // مقبض السحب بلون متناسق
          ...
          Text(
            ...
            style: TextStyle(
              fontSize: 22, 
              fontWeight: FontWeight.w900, // وضوح ومنع أخطاء التيرمينال
              color: textColor
            ),
          ),
          const SizedBox(height: 30),
          
          // حقول الإدخال بستايل الأخضر الملكي
          ...
          ElevatedButton(
            ...
            onPressed: () {
              if (_compController.text.isNotEmpty) {
                provider.addExperience(_compController.text, _posController.text, _durController.text);
                _compController.clear(); _posController.clear(); _durController.clear();
              }
            },
            child: Text(
          ...
          // عرض قائمة الخبرات ببطاقات ملكية
          Expanded(
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    title: Text(exp['company']!, style: TextStyle(color: textColor, fontWeight: FontWeight.w900)),
                    subtitle: Text(
                      "${exp['position']} | ${exp['duration']}",
                      style: TextStyle(color: textColor.withOpacity(0.7), fontSize: 13, fontWeight: FontWeight.w500),
                    ),
                    trailing: IconButton(
                      icon: Icon(Icons.delete_sweep_rounded, color: Colors.redAccent.withOpacity(0.8)),
