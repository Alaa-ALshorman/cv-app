      ...
      build: (pw.Context context) {
        return pw.Padding(
          ...
          child: pw.Directionality(
            textDirection:
                provider.isArabic ? pw.TextDirection.rtl : pw.TextDirection.ltr,
            child: pw.Column(
              ...
              children: [
                        ...
                        children: [
                          ...
                          pw.Text(provider.jobTitle,
                              style: const pw.TextStyle(
                                  fontSize: 14, color: PdfColors.teal700)),
                ...
                if (provider.university.isNotEmpty) ...[
                  ...
                  _buildSectionTitle(
                      provider.isArabic ? "المؤهلات العلمية" : "Education"),
                  pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.start,
                    children: [
                      pw.Text(provider.university,
                          style: pw.TextStyle(
                      ...
                      pw.Row(
                        ...
                        children: [
                          if (provider.degree.isNotEmpty)
                            pw.Text(provider.degree,
                                style: const pw.TextStyle(fontSize: 11)),
                          if (provider.gradYear.isNotEmpty)
                            pw.Text(provider.gradYear,
                                style: const pw.TextStyle(
                ...
                if (provider.experiences.isNotEmpty) ...[
                  pw.SizedBox(height: 20),
                  _buildSectionTitle(
                      provider.isArabic ? "الخبرات العملية" : "Work Experience"),
                  ...
                  pw.Wrap(
                    ...
                    children: provider.skills
                        .map((skill) => pw.Container(
                              ...
                              child: pw.Text(skill,
                                  style: const pw.TextStyle(
                                      fontSize: 10, color: PdfColors.teal900)),
                            ))
                        .toList(),
                  ),
                ],
