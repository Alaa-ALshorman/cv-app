                  ...
                  children: [
                    pw.Expanded(
                      child: pw.Column(
                        ...
                        children: [
                          pw.Text(provider.fullName.toUpperCase(), style: pw.TextStyle(fontSize: 26, color: PdfColors.white, fontWeight: pw.FontWeight.bold)),
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    if (provider.university.isNotEmpty) ...[
                      ...
                      pw.Text("${provider.degree} ${provider.gradYear.isNotEmpty ? '(${provider.gradYear})' : ''}", 
